...
RUN echo "c.NotebookApp.password=\"$(echo ${PASSWD:-mypasswd} | python -c 'from notebook.auth import passwd;print(passwd(input()))')\"" >> /home/jovyan/.jupyter/jupyter_notebook_config.py
ENV PASSWD=
