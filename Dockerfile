...
ENTRYPOINT ["jupyter lab --port 8080 --no-browser --ip 0.0.0.0 --NotebookApp.password \"$(echo ${PASSWD:-mypasswd} | python -c 'from notebook.auth import passwd;print(passwd(input()))')\""]
